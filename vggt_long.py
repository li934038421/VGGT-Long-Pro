...
from base_models.base_model import VGGTAdapter,Pi3Adapter,MapAnythingAdapter, FastVGGTAdapter
...
class VGGT_Long:
    def __init__(self, image_dir, save_dir, config):
        ...
        self.merge_ratio = self.config['Model']['merge_ratio']
        self.seed = 42
        ...
        if self.config['Weights']['model'] == 'VGGT':
            ...
            self.model = FastVGGTAdapter(self.config)
